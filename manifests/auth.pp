...
define pam::auth (
  ...
  Optional[Integer[-1]]  $cracklib_dcredit          = $::pam::cracklib_dcredit,
  Optional[Integer[-1]]  $cracklib_ucredit          = $::pam::cracklib_ucredit,
  Optional[Integer[-1]]  $cracklib_lcredit          = $::pam::cracklib_lcredit,
  Optional[Integer[-1]]  $cracklib_ocredit          = $::pam::cracklib_ocredit,
